...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 01, 2024 lúc 04:56 AM
...
ALTER TABLE `tbl_brand`
  ...
  ADD KEY `tbl_cartegory-cartegory_id` (`cartegory_id`);
...
--
ALTER TABLE `tbl_cartegory`
  MODIFY `cartegory_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `tbl_brand`
  ADD CONSTRAINT `tbl_cartegory-cartegory_id` FOREIGN KEY (`cartegory_id`) REFERENCES `tbl_cartegory` (`cartegory_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
